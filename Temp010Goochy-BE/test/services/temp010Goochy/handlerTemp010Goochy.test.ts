...
import { handler } from "../../../src/services/temp010Goochy/handlerTemp010Goochy";
...
describe("Temp010Goochy handler test suite", () => {
	test("Returns temp010Goochy from dynamoDb", async () => {
