...
import { handler } from "../../../src/services/temp009Goochy/handlerTemp009Goochy";
...
describe("Temp009Goochy handler test suite", () => {
	test("Returns temp009Goochy from dynamoDb", async () => {
